export default {
  ...
  "home.bullet.a.description": "Hosta Tinkerme Share på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad Tinkerme Share med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL Tinkerme Share finns",
