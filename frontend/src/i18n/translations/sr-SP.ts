export default {
  ...
  "home.bullet.a.description": "Хостујте Tinkerme Share на својој машини.",
  ...
  "admin.config.general.app-url.description": "На којој URL адреси је доступан Tinkerme Share",
