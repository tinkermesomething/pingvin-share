export default {
  ...
  "home.bullet.a.description": "Utrzymuj Tinkerme Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Tinkerme Share jest dostępny",
