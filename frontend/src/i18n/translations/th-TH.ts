export default {
  ...
  "home.bullet.a.description": "โฮสต์ Tinkerme Share บนเครื่องของคุณเอง.",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน Tinkerme Share ได้",
