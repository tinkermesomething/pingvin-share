export default {
  ...
  "home.bullet.a.description": "Betreibe Tinkerme Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Tinkerme Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Tinkerme Share verfügbar ist",
