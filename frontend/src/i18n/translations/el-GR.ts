export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Tinkerme Share στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured Tinkerme Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Tinkerme Share είναι διαθέσιμο",
