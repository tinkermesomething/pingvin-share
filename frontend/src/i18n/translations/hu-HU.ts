export default {
  ...
  "home.bullet.a.description": "A Tinkerme Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Tinkerme Share megosztáskezelőre mutató hivatkozás",
