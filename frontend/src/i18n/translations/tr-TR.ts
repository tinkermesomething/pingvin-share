export default {
  ...
  "home.bullet.a.description": "Tinkerme Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Tinkerme Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Tinkerme Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Tinkerme Share bilgileri bellekte önbellekler. Birden fazla Tinkerme Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
