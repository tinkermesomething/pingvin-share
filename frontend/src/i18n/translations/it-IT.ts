export default {
  ...
  "home.bullet.a.description": "Configura Tinkerme Share sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato Tinkerme Share tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL Tinkerme Share è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente Tinkerme Share mantiene la cache in memoria. Se si eseguono più istanze di Tinkerme Share, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
