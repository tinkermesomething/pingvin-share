export default {
  ...
  "home.bullet.a.description": "Host Tinkerme Share på din egen maskine.",
  ...
  "admin.config.general.app-url.description": "På hvilken URL Tinkerme Share er tilgængelig",
