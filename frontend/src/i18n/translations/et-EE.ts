export default {
  ...
  "home.bullet.a.description": "Hosti Tinkerme Share oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud Tinkerme Share konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu Tinkerme Share on kättesaadav",
