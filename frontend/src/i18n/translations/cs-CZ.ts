export default {
  ...
  "home.bullet.a.description": "Hostujte Tinkerme Share na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Tinkerme Share nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Tinkerme Share k dispozici",
